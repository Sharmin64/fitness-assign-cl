...
const Button = ({ buttonName }: TButtonName) => {
  return (
    <>
      <button className=" text-[1.2em] inline-block font-medium text-[#056a7f] border-4 border-[#519faf] px-16 py-2 rounded-full hover:text-white hover:text-center group relative items-center text-center overflow-hidden indent-0 bg-[#cde4e8]">
