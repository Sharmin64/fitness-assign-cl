...
const Button = ({ buttonName }: TButtonName) => {
  return (
    <>
      <button className=" text-lg font-medium text-[#01181c] border-4 border-[#519faf] px-16 py-2 rounded-full hover:text-white hover:text-center group relative flex items-center text-center overflow-hidden indent-0">
